...
###1. Wstęp1.1. Wprowadzenie do systemów rozproszonych i problemu spójności danych.
1.2. Cel i zakres pracy.
1.3. Uzasadnienie wyboru technologii (Go, gRPC, Protocol Buffers).
1.4. Struktura pracy.

###2. Podstawy teoretyczne i przegląd rozwiązań2.1. Modele spójności w systemach rozproszonych.
...
###3. Analiza wymagań i projekt architektury systemu3.1. Wymagania funkcjonalne i niefunkcjonalne (w tym odporność na partycjonowanie sieci - Network Partition Tolerance).
...
###4. Implementacja modułu konsensusu Raft (`pkg/raft`)4.1. Maszyna stanów węzła Raft.
...
###6. Weryfikacja poprawności i testy odporności (Fault Injection)6.1. Metodyka testowania systemów rozproszonych.
...
###7. Analiza wydajności i porównanie z istniejącymi rozwiązaniami7.1. Środowisko testowe i metodologia pomiarów (`tests/benchmark`).
...
###8. Podsumowanie8.1. Ocena stopnia realizacji celów pracy.
