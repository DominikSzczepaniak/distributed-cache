...
\bibitem{neo4j} Neo4j, "Causal Clustering Architecture," [Online]. Available: https://neo4j.com/docs/operations-manual/current/clustering/introduction/. [Accessed: 20-Dec-2024].
...
\bibitem{cassandra} Apache Cassandra, "Dataset Partitioning: Consistent Hashing" [Online]. Available: \text{https://cassandra.apache.org/doc/5.0/cassandra/architecture/dynamo.html\#dataset-partitioning-consistent-hashing}. [Accessed: 21-Dec-2024].
\end{thebibliography}
