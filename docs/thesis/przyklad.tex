...
The system is built using an architecture that separates itself into layers. This design allows to detect server failures and automatically reorginize itself without compromising any data integrity. The system is supported with a specialized client library that optimizes communication and ensures that requests are router as efficiently as possible to the correct server.
