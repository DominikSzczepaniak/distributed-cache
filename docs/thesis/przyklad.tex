%to add:
% section about CI/CD
% section about docker setup and instructions
% section about architectures analysis - its mostly in notes. write about hazelcast, redis, google spanner, amazon, types of hashing etc. THIS IN 2.4
...
\subsubsection{Lamping And Veach's Jump Consistent Hash}
...
\subsubsection{The sorted monolithic map}
...
\subsection{Analysis of industry solutions}


\subsubsection{Redis cluster: Pre-sharded "Hash slots"} %add more about gossip protocol
...
\subsubsection{Hazelcast IMDG} %Virtual Bucket pattern (used by couchbase)
...
\subsection{Dynamic Node Membership and Capacity Scaling}
