...
type RaftClient interface {
	Forward(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Null, error)
...
func (c *raftClient) Forward(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Null, error) {
...
type RaftServer interface {
	Forward(context.Context, *Message) (*Null, error)
...
func (UnimplementedRaftServer) Forward(context.Context, *Message) (*Null, error) {
