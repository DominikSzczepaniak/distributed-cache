...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\asuccess\x18\x04 \x01(\bR\asuccess2\xe6\x01\n" +
	"\x04Raft\x12(\n" +
	...
	"\tHeartbeat\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.EmptyB=Z;github.com/dominikszczepaniak/distributed-cache/raft/raftpbb\x06proto3"
...
var file_proto_raft_proto_depIdxs = []int32{
	...
	9, // 7: raftpb.Raft.Heartbeat:input_type -> google.protobuf.Empty
	2, // 8: raftpb.Raft.Forward:output_type -> raftpb.Null
	5, // 9: raftpb.Raft.VoteRequest:output_type -> raftpb.VoteResponse
	7, // 10: raftpb.Raft.LogRequest:output_type -> raftpb.LogResponse
	9, // 11: raftpb.Raft.Heartbeat:output_type -> google.protobuf.Empty
