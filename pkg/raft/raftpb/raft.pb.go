...
const file_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x10proto/raft.proto\x12\x06raftpb\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x9e\x01\n" +
	"\aMessage\x12(\n" +
	...
	"\x04term\x18\x01 \x01(\x05R\x04term2\xba\x02\n" +
	"\x04Raft\x12(\n" +
...
var file_proto_raft_proto_depIdxs = []int32{
	...
	10, // 1: raftpb.Message.value:type_name -> google.protobuf.Int32Value
	...
	11, // 7: raftpb.Raft.Heartbeat:input_type -> google.protobuf.Empty
	8,  // 8: raftpb.Raft.InstallSnapshot:input_type -> raftpb.InstallSnapshotRequest
	2,  // 9: raftpb.Raft.Forward:output_type -> raftpb.Null
	5,  // 10: raftpb.Raft.VoteRequest:output_type -> raftpb.VoteResponse
	7,  // 11: raftpb.Raft.LogRequest:output_type -> raftpb.LogResponse
	11, // 12: raftpb.Raft.Heartbeat:output_type -> google.protobuf.Empty
	9,  // 13: raftpb.Raft.InstallSnapshot:output_type -> raftpb.InstallSnapshotResponse
